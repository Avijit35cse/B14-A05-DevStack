    ...
    return (
        <section className="container mx-auto mb-10 sm:px-8 xl:px-10 mt-16 sm:mt-20 lg:mt-24 xl:mt-28">
            <div className="flex flex-col gap-2 py-8 px-4 sm:px-0">
                <h2 className="text-[30px] sm:text-[34px] lg:text-[36px] text-center lg:text-left  font-inter font-extrabold leading-9">Explore the <span className="bg-linear-to-r from-[#ec4899] to-[#8b5cf6] bg-clip-text text-transparent">Technologies</span></h2>
