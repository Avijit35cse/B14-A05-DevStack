    ...
    return (
        <section className="flex flex-col md:flex-row lg:flex-row gap-8 lg:gap-4 container justify-between items-center mt-12 md:mt-24 mx-auto px-4 sm:px-10">
            <div className="w-full lg:w-1/2">
                <h2
                    className="text-[40px] sm:text-[48px] lg:text-[60px] text-center lg:text-left font-inter font-semibold leading-[1.1] mb-4 max-w-162.5 ">
                    Build Your Ideal<br />
                    <span
                ...
                <div
                    ...
                    <button className="btn rounded-xl border border-[#E5E7EB] text-[14px] text-[#374151] font-normal">Learn More</button>
                </div>
            </div>
